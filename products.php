...
<!-- FORM TO ADD A NEW PRODUCT -->
    ...
    <div class="form-floating mb-3">
        <input type="text" name="quantity" class="form-control" id="floatingquantity" placeholder="quantity"
            value="<?= $product["quantity"] ?>">
        <label for="floatingquantity">Quantity</label>
    </div>


    <button class="w-100 btn btn-lg btn-primary" type="submit" name="modifyProduct">Update</button>
